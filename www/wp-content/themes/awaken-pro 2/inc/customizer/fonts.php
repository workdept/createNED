 ...
 * @package Awaken Pro
 */
if ( ! function_exists( 'awaken_pro_get_font_choices' ) ) :
/**
 ...
 */
function awaken_pro_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'awaken-pro' ) ) ) );
	$standard_fonts = awaken_pro_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'awaken-pro' ) ) ) );
	$google_fonts   = awaken_pro_get_google_fonts();
	/**
	 ...
	 */
	return apply_filters( 'awaken_pro_all_fonts', array_merge( $heading1, $standard_fonts, $heading2, $google_fonts ) );
}
endif;
if ( ! function_exists( 'awaken_pro_get_font_choices' ) ) :
/**
 ...
 * @return array    The fonts in value/label pairs.
 */
function awaken_pro_get_font_choices() {
	$fonts   = awaken_pro_get_all_fonts();
	$choices = array();
...
if ( ! function_exists( 'awaken_pro_get_google_font_uri' ) ) :
/**
 ...
 */
function awaken_pro_get_google_font_uri( $fonts ) {
	// De-dupe the fonts
	$fonts         = array_unique( $fonts );
	$allowed_fonts = awaken_pro_get_google_fonts();
	$family        = array();
	...
	foreach ( $fonts as $font ) {
		...
		if ( array_key_exists( $font, $allowed_fonts ) ) {
			...
			$family[] = urlencode( $font . ':' . join( ',', awaken_pro_choose_google_font_variants( $font, $allowed_fonts[ $font ]['variants'] ) ) );
		}
	}
	...
	// 	$subset = get_theme_mod( 'font-subset', awaken_pro_get_default( 'font-subset' ) );

	$subset = get_theme_mod( 'font-subset', 'latin' );

	if ( 'all' === $subset ) {
		$subsets_available = awaken_pro_get_google_font_subsets();
		// Remove the all set
...
if ( ! function_exists( 'awaken_pro_get_google_font_subsets' ) ) :
/**
 ...
 */
function awaken_pro_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'awaken-pro' ),
		'cyrillic'     => __( 'Cyrillic', 'awaken-pro' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'awaken-pro' ),
		'devanagari'   => __( 'Devanagari', 'awaken-pro' ),
		'greek'        => __( 'Greek', 'awaken-pro' ),
		'greek-ext'    => __( 'Greek Extended', 'awaken-pro' ),
		'khmer'        => __( 'Khmer', 'awaken-pro' ),
		'latin'        => __( 'Latin', 'awaken-pro' ),
		'latin-ext'    => __( 'Latin Extended', 'awaken-pro' ),
		'vietnamese'   => __( 'Vietnamese', 'awaken-pro' ),
	);
}
endif;
if ( ! function_exists( 'awaken_pro_choose_google_font_variants' ) ) :
/**
 ...
 */
function awaken_pro_choose_google_font_variants( $font, $variants = array() ) {
	$chosen_variants = array();
	if ( empty( $variants ) ) {
		$fonts = awaken_pro_get_google_fonts();
	...
	return apply_filters( 'awaken_pro_font_variants', array_unique( $chosen_variants ), $font, $variants );
}
endif;
if ( ! function_exists( 'awaken_pro_get_standard_fonts' ) ) :
/**
 ...
 */
function awaken_pro_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'awaken-pro' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'awaken-pro' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'awaken-pro' ),
			'stack' => 'Monaco,"Lucida Sans Typewriter","Lucida Typewriter","Courier New",Courier,monospace'
		)
	);
}
endif;
if ( ! function_exists( 'awaken_pro_get_font_stack' ) ) :
/**
 ...
 */
function awaken_pro_get_font_stack( $font ) {
	$all_fonts = awaken_pro_get_all_fonts();
	// Sanitize font choice
	$font = awaken_pro_sanitize_font_choice( $font );
...
if ( ! function_exists( 'awaken_pro_sanitize_font_choice' ) ) :
/**
 ...
 */
function awaken_pro_sanitize_font_choice( $value ) {
	if ( is_int( $value ) ) {
		// The array key is an integer, so the chosen option is a heading, not a real choice
		return '';
	} else if ( array_key_exists( $value, awaken_pro_get_font_choices() ) ) {
		return $value;
	} else {
		return '';
	}
...
if ( ! function_exists( 'awaken_pro_get_google_fonts' ) ) :
/**
 ...
 */
function awaken_pro_get_google_fonts() {
	return apply_filters( 'awaken_pro_get_google_fonts', array(
		'ABeeZee' => array(
			'label'    => 'ABeeZee',
			'variants' => array(
				'regular',
