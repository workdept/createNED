...
class Awaken_Tabbed_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'awaken_pro_tabbed_widget', // Base ID
			__( 'Awaken: Popular Posts, Tags, Comments', 'awaken-pro' ), // Name
			array( 'description' => __( 'Displays popular posts, comments, tags in a tabbed pane.', 'awaken-pro' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'nop' ); ?>"><?php _e( 'Number of popular posts:', 'awaken-pro' ); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'noc' ); ?>"><?php _e( 'Number of comments:', 'awaken-pro' ); ?></label> 
...
<ul class="nav nav-tabs" id="awt-widget">
	<li><a href="#awaken-popular" role="tab" data-toggle="tab"><?php _e( 'Popular', 'awaken-pro' ); ?></a></li>
	<li><a href="#awaken-comments" role="tab" data-toggle="tab"><?php _e( 'Comments', 'awaken-pro' ); ?></a></li>
	<li><a href="#awaken-tags" role="tab" data-toggle="tab"><?php _e( 'Tags', 'awaken-pro' ); ?></a></li>
</ul>
...
function register_awaken_pro_tabbed_widget() {
    register_widget( 'Awaken_Tabbed_Widget' );
}
add_action( 'widgets_init', 'register_awaken_pro_tabbed_widget' ); 