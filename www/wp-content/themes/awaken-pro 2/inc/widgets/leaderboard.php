...
class Awaken_Leaderboard_Ad extends WP_Widget {

	/* Register Widget with WordPress*/
	function __construct() {
		parent::__construct(
			'awaken_pro_leaderboard_ad', // Base ID
			__( 'Awaken: 728x90 Ad', 'awaken-pro' ), // Name
			array( 'description' => __( 'Displays a 728x90 responsive leaderboard ad unit.', 'awaken-pro' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		$defaults = array(
			'title'		=>	'',
			'img_url'	=>	get_template_directory_uri()."/images/ad728.jpg",
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'img_url' ); ?>"><?php _e( 'Image Link', 'awaken-pro' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'dest_url' ); ?>"><?php _e( 'Destination Link', 'awaken-pro' ); ?></label>
...
// register widget
function register_leaderboard_ad() {
    register_widget( 'Awaken_Leaderboard_Ad' );
}
add_action( 'widgets_init', 'register_leaderboard_ad' );