...
class Awaken_Medium_Rectangle_Ad extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'awaken_pro_medium_rectangle_ad', // Base ID
			__( 'Awaken: 300x250 Ad', 'awaken-pro' ), // Name
			array( 'description' => __( 'Displays a 300x250 ad unit.', 'awaken-pro' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		//print_r($instance);
		$defaults = array(
			'title'		=>	__( 'Advertisement', 'awaken-pro' ),
...
// register widget
function register_awaken_pro_medium_rectangle_ad() {
    register_widget( 'Awaken_Medium_Rectangle_Ad' );
}
add_action( 'widgets_init', 'register_awaken_pro_medium_rectangle_ad' );