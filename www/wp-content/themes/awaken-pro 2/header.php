...
<div id="page" class="hfeed site">
	<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'awaken-pro' ); ?></a>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12 col-md-8 <?php echo $rtl; ?>">
							...
							<a href="#" class="navbutton" id="top-nav-button"><?php _e( 'Top Menu', 'awaken-pro' ); ?></a>
							<div class="responsive-topnav"></div>			
						</div><!-- col-xs-12 col-sm-8 col-md-8 -->
						<div class="col-xs-12 col-sm-12 col-md-4">
							<?php awaken_pro_socialmedia(); ?>
	...
	<div class="container">
		<div class="awaken-navigation-container">
			...
			<a href="#" class="navbutton" id="main-nav-button"><?php _e( 'Main Menu', 'awaken-pro' ); ?></a>
			...
			<div class="awaken-search-box-container">
				<div class="awaken-search-box">
					<form action="<?php echo esc_url( home_url( '/' ) ); ?>" id="awaken-search-form" method="get">
						...
						<input type="submit" value="<?php esc_attr_e( 'Search', 'awaken-pro' ); ?>" />
					</form>
				</div><!-- th-search-box -->
